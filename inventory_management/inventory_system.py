"""
This is a test harness for the problem for the Inventory Management problem outlined here: https://staffengprep.com/companies/anthropic/
...
After implementing the first level here, run `python inventory_management/test.py --level 1` and progress through all levels to level 3.
